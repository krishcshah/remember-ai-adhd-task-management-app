      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-hidden">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-stone-900 w-full max-w-sm rounded-3xl p-5 shadow-2xl border border-stone-200/80 dark:border-stone-800 relative z-10"
          >
            ...
            <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {COLOR_PALETTES.map((pal) => (
                    <motion.button
                      ...
                      className={`h-9 rounded-xl flex items-center justify-center gap-1.5 text-xs font-semibold border transition-all cursor-pointer ${
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={!label.trim()}
                  className="px-5 py-2 rounded-xl bg-teal-800 hover:bg-teal-900 text-amber-300 font-bold text-xs shadow-sm flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
                >
